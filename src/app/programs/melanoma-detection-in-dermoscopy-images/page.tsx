  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="p-6 pt-2">
        <h1 className="text-2xl font-bold mb-4 text-center">Melanoma Detection Application</h1>
        <p className="mb-4">
          ...
          project is available on my GitHub, and a detailed report can be found in the projects section of this website.
        </p>
