  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="p-6 md:p-14 md:pt-2">
        <h1 className="text-2xl font-bold mb-4 text-center">Melanoma Detection In Dermoscopy Images</h1>
        <p className="mb-4">
          This application is designed to differentiate between malignant melanomas and benign skin lesions in
          dermoscopy images using image processing algorithms combined with machine learning. All the code for this
          project is available on my{' '}
          <Link
            className="underline text-blue-700"
            target="_blank"
            href="https://github.com/AgustinCartaya/s3-binary-skin-lesion-detection-ml.git"
          >
            GitHub
          </Link>
          , and a detailed report can be found in the projects section of this website.
        </p>
        ...
        <ul className="list-decimal list-inside mb-4">
          ...
          <li>Wait for the result image (the analysis may take a few minutes).</li>
        </ul>
        <p>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>The image must be a dermoscopy image with the lesion centered.</li>
          <li>It should not contain any prior segmentations or annotations (ruler marks are allowed).</li>
      ...
      <div className="flex justify-center">
        ...
        <p>
          <mark>
            This application is intended for academic purposes only and is not validated for use by medical
            professionals. The results may not be fully accurate, as the algorithm is still under development.
          </mark>
        </p>
