  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="p-6 md:p-14 md:pt-2">
        <h1 className="text-2xl font-bold mb-4 text-center">Classification of Malignant Skin Lesions</h1>
        <p className="mb-4">
          This application is designed to differentiate between melanomas, Basal Cells and Squamous cell in dermoscopy
          images using image processing algorithms combined with machine learning. All the code for this project is
          available on my{' '}
          <Link
