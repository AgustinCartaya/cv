  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="p-6 md:p-14 md:pt-2">
        <h1 className="text-2xl font-bold mb-4 text-center">Soft Exudate Detection In Retinal Fundus Images</h1>
        <p className="mb-4">
          This application is designed to detect soft exudates (SEx) in retinal fundus images using image processing
          algorithms combined with machine learning. All the code for this project is available on my{' '}
          <Link
        ...
        <p>
          You can also use the provided test image to see how the application works by selecting{' '}
